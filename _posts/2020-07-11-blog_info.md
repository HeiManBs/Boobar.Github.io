...
在此之前我有写过一篇[如何使用我博客模板的文章](https://github.com/HeiManBs/Boobar.Github.io/tree/dev) 请先看这篇基础集成，这篇文章主要讲的是如何使用和修改我的博客主题，文章内容含以下几点：
...
博客迭代信息请看[ReleaseNode](https://github.com/HeiManBs/Boobar.Github.io/tree/dev)

遇到解决不了的问题可以找 [技术支持](https://github.com/HeiManBs/Boobar.Github.io/tree/dev)
